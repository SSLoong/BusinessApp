...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
	{
		//defaults
		self.on = NO;
		self.offColor = self.offColor = [UIColor colorWithRed:0.79 green:0.79 blue:0.79 alpha:0.2];
		...
		[self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-10-[label]-10-|"
																	 options:0
																	 metrics:nil
																	   views:views]];
